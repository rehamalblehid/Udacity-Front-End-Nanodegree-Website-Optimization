...
- Used a media query on the print.css.
- Added async to all JavaScript tags and minify perfmatters.js.
- Resize pizzeria image and compressed profilepic.jpg and pizzeria.png.

#### Part 2: Optimize Frames per Second in pizza.html
To load the pizza website open a browser and navigate to views/pizza.html in your browser.
